...
/////MARK: - [22]
//
// Priority is set in order to restrict resizing of arranged views, while container is animated.
// For example : text size changed, reaction was added, replyToMessage view was removed etc.
// All this things will result in container bounds change,
// so we prevent arranged views, on constraints update, to be resized


/////MARK: - [23]
//
/// This is an optimisation for fast scroll, the WaveformScrubber view creation is expensive,
/// and during fast scroll, like for example when tapping on scrollToBottom button and having table view
/// full of voice messages, the scroll animation will be a bit glitchy.
/// So task is created to delay setup and achive butter smooth scroll effect
