...
//{
//    private static var preferredRenderSize: CGSize = .init(width: 150, height: 150)
//    
...
//            StickerAnimationManager.shared.render(animation: localAnim,
//                                                         frame: currentFrame,
//                                                         buffer: localBuffer,
//                                                         size: self.renderSize)
//
//            await self.createAndDisplayImage(from: localBuffer)
//            await MainActor.run {
...
//    {
//        Task {
//            StickerAnimationManager.shared.destroyAnimation
//            {
